...
describe("transaction_hashing_and_merkle_trees", () => {
	...
	it("playground", async () => {
		...
		const merkleRoot = 16247412791711058059958322912866945196043536767728836384345637472479895576331n;
		const tx = tx_array[4];

		const path_ = [0n, 0n, 17979291733834645102530182788181826513193316690362781568893660924490084521137n];
